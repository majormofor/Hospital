...
if (isset($_POST['submit'])) {
    ...
    if (strlen($password) < 8 || !preg_match("#[0-9]+#", $password) || !preg_match("#[A-Z]+#", $password) || !preg_match("#\W+#", $password)) {
      echo "<script> alert('Password should be at least 8 characters long, contain at least one digit, one capital letter, and one special character! Click OK to go back and try again.'); history.go(-1); </script>";
      exit;
  }
...
<body>
    <img src="/patient/images/login4.jpg" alt="background image"
