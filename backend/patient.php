                    ...
                    <div class="d-flex align-items-start">
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                            ...
                            <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill"
                                ...
                                aria-controls="v-pills-messages" aria-selected="false">View Prescriptions</button>
                            <button class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-settings" type="button" role="tab"
                                aria-controls="v-pills-settings" aria-selected="false">Book an Appointment</button>
                            <button class="nav-link" id="v-pills-appointment-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-appointment" type="button" role="tab"
                                aria-controls="v-pills-appointment" aria-selected="false">View Appointments</button>
                            <button class="nav-link" id="v-pills-MedicalRecord-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-MedicalRecord" type="button" role="tab"
                                aria-controls="v-MedicalRecord" aria-selected="false">Medical Test Records</button>
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                ...
                                <div class="jumbotron jumbotron-fluid">
                                    <div class="container">
                                        <h1 class="display-4">Welcome <?php echo $row['firstname']; ?> to Mofor Practice
                                            Care</h1>
                                        <p>We care about your health and well-being. Our team of experienced medical
                                            professionals is dedicated to providing you with the best possible care.</p>
                                        <hr class="my-4">
                                        <p>On our website, you can book appointments, check your medical results, and
                                            keep track of your health history. Just by using the links at the left hand
                                            side of these page</p>
                                    </div>
                                </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="card">
                                                <img class="card-img-top" src="../assets/images/blog1.jpg"
                                                    alt="Card image cap" height="150" width="350">
                                                <div class="card-body">
                                                    <h5 class="card-title">Read Our Blog</h5>
                                                    <p class="card-text">Get informed and stay up-to-date with the
                                                        latest health news and tips from our experts at Mofor Practice.
                                                        Explore our blog and discover useful insights and advice to help
                                                        you lead a healthier life.</p>
                                        ...
                                        <div class="col-md-4">
                                            <div class="card">
                                                <img class="card-img-top" src="../assets/images/test.jpg"
                                                    alt="Card image cap" height="150" width="350">
                                                <div class="card-body">
                                                    <h5 class="card-title">Write a Testimonial</h5>
                                                    <p class="card-text">Share your experience and help others by
                                                        writing a testimonial about your care at Mofor Practice.</p>
                                        ...
                                        <div class="col-md-4">
                                            <div class="card">
                                                <img class="card-img-top" src="../assets/images/test1.jpg"
                                                    alt="Card image cap" height="150" width="350">

                                                <div class="card-body">
                                                    <h5 class="card-title">Testimonials</h5>
                                                    <p class="card-text">Hear from patients like you about their
                                                        experiences at Mofor Practice Care.</p>
                                                    <a href="Feedback.php" class="btn btn-primary">Read Testimonials</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <a href='updatepatient.php?patient_id=<?php echo $row["patient_id"]; ?>'
                            ...
                            <div class="tab-pane fade" id="v-pills-appointment" role="tabpanel"
                                aria-labelledby="v-pills-appointment-tab" tabindex="0">
                                <div class="row">
                            ...
                            <div class="tab-pane fade" id="v-pills-MedicalRecord" role="tabpanel"
                                aria-labelledby="v-pills-MedicalRecord-tab" tabindex="0">
                                <div class="blac">
                                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="pills-h-tab" data-bs-toggle="pill"
                                                ...
                                                aria-controls="pills-h" aria-selected="true"> Urinalysis Test</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="pills-ho-tab" data-bs-toggle="pill"
                                                data-bs-target="#pills-ho" type="button" role="tab"
                                                aria-controls="pills-ho" aria-selected="true"> Stool Test</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="pills-hom-tab" data-bs-toggle="pill"
                                                data-bs-target="#pills-hom" type="button" role="tab"
                                                aria-controls="pills-hom" aria-selected="true"> Imaging Testing</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link " id="pills-home-tab" data-bs-toggle="pill"
                                                data-bs-target="#pills-home" type="button" role="tab"
                                                aria-controls="pills-home" aria-selected="true">Blood Count
                                                Test</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                                data-bs-target="#pills-profile" type="button" role="tab"
                                                aria-controls="pills-profile" aria-selected="false">Lipid Profile
                                                Test</button>
                                        </li>
                                    ...
                                    ?>
                                        ...
                                        <!-- Stool Test start -->
                                        <div class="tab-pane fade" id="pills-ho" role="tabpanel"
                                            ...
                                            <div class="container">
                                             ...
                                             // SQL query to retrieve stool test results
                                                 $patient_id = $_SESSION['patient_id'];
                                                 $sql = "SELECT * FROM stool_tests WHERE patient_id = '$patient_id'";
                                                 // Execute the query
                                        $result = mysqli_query($conn, $sql);
                                        ...
                                        <div class="tab-pane fade " id="pills-hom" role="tabpanel"
                                            aria-labelledby="pills-hom-tab" tabindex="0">
                                            <div class="container">
                                            ...
                                            $patient_id = $_SESSION['patient_id'];
                                             ...
                                             // SQL query to retrieve stool test results
                                             $sql = "SELECT * FROM imaging WHERE patient_id = '$patient_id'";
                                             // Execute the query
                                           $result = mysqli_query($conn, $sql);
                                           ...
                                           if (mysqli_num_rows($result) > 0) {
                                            while ($row = mysqli_fetch_assoc($result)) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img src="../assets/uploads/<?php echo $row['file']; ?>"
                                ...
                                ?>
                                    ...
                                    ?>
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <img src="../assets/images/lipid1.jpg"
                                                            alt="Lipid Profile Test Image" style="width:100%">
                                                    </div>
                                                    <div class="col-md-8">
                                                        <table class="table table-striped">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $row['total_cholesterol']; ?> mg/dL
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td><strong>HDL Cholesterol:</strong></td>
                                                                    <td><?php echo $row['hdl_cholesterol']; ?> mg/dL
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td><strong>LDL Cholesterol:</strong></td>
                                                                    <td><?php echo $row['ldl_cholesterol']; ?> mg/dL
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                    ...
                                    ?>
                                            ...
                                            <!-- Stool Test Start-->
                                            <div class="tab-pane fade" id="pills-stool" role="tabpanel"
                                                aria-labelledby="pills-stool-tab" tabindex="0">
                                            ...
                                            <div class="tab-pane fade" id="pills-imaging" role="tabpanel"
                                                aria-labelledby="pills-imaging-tab" tabindex="0">
                                ...
                                <div class="tab-pane fade" id="v-pills-settingsaa" role="tabpanel"
