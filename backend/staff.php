...
<body>
    ...
    <img src="../assets/images/stafff.jpg" alt="background image"
    ...
    <div class="container blac">
        <div class="row">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                            ...
                            aria-selected="false">Booked Appointment</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-Mine-tab" data-bs-toggle="pill" data-bs-target="#pills-Mine"
                            type="button" role="tab" aria-controls="pills-Mine" aria-selected="false">My
                            Appointment</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-medication-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-medication" type="button" role="tab" aria-controls="pills-medication"
                            aria-selected="false">Prescription Form</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-Record-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-Record" type="button" role="tab" aria-controls="pills-Record"
                            aria-selected="false">Medical Record Form</button>
                    </li>
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        ...
                        <div class="container mt-5">
                            ...
                            <p>As a member of our team, we appreciate your hard work and dedication to providing
                                high-quality healthcare to our patients.</p>
                            <hr>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card">
                                        <img class="card-img-top" src="../assets/images/blog.jpg" alt="Card image cap"
                                            height="150" width="350">
                                        <div class="card-body">
                                            <h5 class="card-title">Write a Blog Post</h5>
                                            <p class="card-text">Share your experience and knowledge to help others by
                                                writing a Blog about your care at Mofor Practice.</p>
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <img class="card-img-top" src="../assets/images/test.jpg" alt="Card image cap"
                                            height="150" width="350">
                                        <div class="card-body">
                                            <h5 class="card-title">Write a Testimonial</h5>
                                            <p class="card-text">Share your experience and help others by writing a
                                                testimonial about your care at Mofor Practice.</p>
                                            <a href="../createfeedback.php" class="btn btn-primary">Write a
                                                Testimonial</a>
                                        </div>
                                    </div>
                                </div>
            ...
            while($row = mysqli_fetch_assoc($result)) { ?>
                    ...
                    <div class="tab-pane fade" id="pills-Mine" role="tabpanel" aria-labelledby="pills-Mine-tab"
                        tabindex="0">
                    ...
                    <div class="tab-pane fade" id="pills-medication" role="tabpanel"
                        aria-labelledby="pills-medication-tab" tabindex="0">
                        <?php
                            $staff_id = $_SESSION['staff_id'];
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <img src="../assets/images/prescription.jpg" alt="Urine Image" height="600px"
                                    width="499px">
                            ...
                            <div class="col-md-7">
                                ...
                                <form method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="instruction" name="instructions"
                                            required>
                                    </div>
                                    <input type="hidden" name="staff_id" value="<?php echo $staff_id; ?>">
                    ...
                    <div class="tab-pane fade" id="pills-Record" role="tabpanel" aria-labelledby="pills-Record-tab"
                        ...
                        <div class="d-flex align-items-start">
                            <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                                ...
                                <button class="nav-link active" id="v-pills-set-tab" data-bs-toggle="pill"
                                    data-bs-target="#v-pills-set" type="button" role="tab" aria-controls="v-pills-set"
                                    aria-selected="false">Imaging Test</button>

                                <button class="nav-link" id="v-pills-home-tab" data-bs-toggle="pill"
                                    data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home"
                                    aria-selected="true">BCT FORM</button>
                                <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill"
                                    data-bs-target="#v-pills-profile" type="button" role="tab"
                                    aria-controls="v-pills-profile" aria-selected="false">Lipid Panel</button>
                                <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill"
                                    data-bs-target="#v-pills-messages" type="button" role="tab"
                                    aria-controls="v-pills-messages" aria-selected="false">Urinalysis Test</button>
                                <button class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill"
                                    data-bs-target="#v-pills-settings" type="button" role="tab"
                                    aria-controls="v-pills-settings" aria-selected="false">Stool Test</button>

                            </div>
                            <div class="tab-content" id="v-pills-tabContent">
                                <!-- imaging start -->
                                <div class="tab-pane fade show active" id="v-pills-set" role="tabpanel"
                                    aria-labelledby="v-pills-set-tab" tabindex="0">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-2">
                                                <img src="../assets/images/imaging.jpg" alt="Urine Image" height="700px"
                                                    width="990px">
                                            </div>
                                            <div class="col-md-8">
                                                <h1>Imaging Test Result Form</h1>
                                                <hr>
                                                <form action="imaging_test.php" method="post"
                                                    enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        <label for="test_date">Test Date</label>
                                                        <input type="date" class="form-control" id="test_date"
                                                            name="test_date" required>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="image_type" name="image_type"
                                                            required>
                                                            <option value="" selected disabled>Select Image Type
                                                            </option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="form-control-file" id="file"
                                                            name="file" accept="image/*,.pdf,.doc,.docx,.txt">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="patient_id">Patient ID</label>
                                            ...
                                            <form method="post" action="process_blood_count.php">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="0.01" class="form-control"
                                                        id="red_blood_cells" name="red_blood_cells" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="white_blood_cells">White Blood Cells
                                                        (thousands/mm³):</label>
                                                    <input type="number" step="0.01" class="form-control"
                                                        id="white_blood_cells" name="white_blood_cells" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="platelet">Platelet (thousands/mm³):</label>
                                                    <input type="number" step="0.01" class="form-control" id="platelet"
                                                        name="platelet" required>
                                                </div>
                                                <div class="form-group">
                                ...
                                <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <img src="../assets/images/lipid.jpg" alt="Lipid Panel Image"
                                                    height="850px">
                                            </div>
                                            <div class="col-md-8">
                                                ...
                                                <form method="POST" action="lipid_panel.php">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" id="hdl_cholesterol"
                                                            name="test_date" required>
                                                    </div>
                                                    <div class="form-group">
                                ...
                                <div class="tab-pane fade" id="v-pills-messages" role="tabpanel"
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-2">
                                                <img src="../assets/images/urine.jpg" alt="Urine Image" height="1000px"
                                                    width="990px">
                                            </div>
                                            <div class="col-md-8">
                                                ...
                                                <form method="post" action="urinalysis.php">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="ketones"
                                                            name="ketones" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="leukocytes">Leukocytes:</label>
                                                        <input type="text" class="form-control" id="leukocytes"
                                                            name="leukocytes" required>
                                                    </div>
                                                    <div class="form-group">
                                ...
                                <div class="tab-pane fade" id="v-pills-settings" role="tabpanel"
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <img src="../assets/images/stool.jpg" alt="Urine Image" height="1200px"
                                                    width="990px">
                                            </div>
                                            <div class="col-md-8 ">
                                                ...
                                                <div class="card-body">
                                                    <form method="post" action="stool_test.php">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="nitrite" name="nitrite"
                                                                required>
                                                                <option value="">-- Select --</option>
                                                                <option value="Negative">Negative</option>
                                                                <option value="Positive">Positive</option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="ova_parasites"
                                                                name="ova_parasites" required>
                                                                <option value="">-- Select --</option>
                                                                <option value="Negative">Negative</option>
                                                                <option value="Positive">Positive</option>
                                                            </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="cdiff_toxin"
                                                                name="cdiff_toxin" required>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="calprotectin"
                                                                name="calprotectin" required>
                                                        </div>
